function get_answer(q_id, new_answer_num){
        return '<p id="'+ q_id +'_a_' + new_answer_num + '"><input id="cb_'+ new_answer_num + '_' + q_id + '" type="checkbox" name="cb_'+ new_answer_num + '_' + q_id + '"> <input class="w-25" type="text" value="Вариант ответа" name="answer_' + new_answer_num + '_' + q_id +'" maxlength="100" required="" id="answer_'+ new_answer_num +'_' + q_id+ '"><a onclick="remove_answer(' + q_id + '_a_'+ new_answer_num + ')"> <img src="/static/admin/img/icon-deletelink.svg" alt="False" title="Удплить вопрос"> </a></p>';
}
...
function get_question(new_q_num){
        return '<fieldset id="q_' + new_q_num + '">' +
            '<p>' +
                ...
                '<br>'+
                '<input class="w-50" type="text" name="text_q_' + new_q_num + '" maxlength="100" required="" id="id_text_q_' + new_q_num + '">' +
                '<a onclick="remove_question(\'q_' + new_q_num + '\')"><img src="/static/admin/img/icon-deletelink.svg" alt="False" title="Удплить вопрос"></a>' +
            '</p>' +
            '<p>' +
                '<label for="id_description_q_' + new_q_num + '">Примечание:</label>' +
                '<br>'+
                '<textarea class="w-50" name="description_q_' + new_q_num + '" cols="40" rows="3" maxlength="250" id="id_description_q_' + new_q_num + '"></textarea>' +
            '</p>' +
